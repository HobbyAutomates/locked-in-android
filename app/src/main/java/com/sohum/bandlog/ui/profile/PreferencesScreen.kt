...
private val CHANGELOG = listOf(
    "2.13" to listOf("Coaching: diet modes backed by science, weekly targets that adapt to your weight trend, What should I eat?, a 4 pm protein nudge, a fasting timer, recipes and a micronutrient dashboard", "Training: routines with a planner, a rest timer, PR charts and a muscle map of what each exercise works; body measurements, editable progress photos and a before/after slider", "Menu scan at restaurants, move a meal to another meal time, clearer item cards, weekly and monthly recaps, Instagram share cards, nudge notifications, and Locked In Pro (free for beta testers)"),
